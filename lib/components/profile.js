...
var StitchingProfileComponent = function (_StitchingBaseCompone) {
    _inherits(StitchingProfileComponent, _StitchingBaseCompone);

    function StitchingProfileComponent(props) {
        _classCallCheck(this, StitchingProfileComponent);

        var _this = _possibleConstructorReturn(this, (StitchingProfileComponent.__proto__ || Object.getPrototypeOf(StitchingProfileComponent)).call(this, props));
    ...
    _createClass(StitchingProfileComponent, [{
        key: "renderMetadata",
    ...
    return StitchingProfileComponent;
}(_base2.default);

StitchingProfileComponent.propTypes = _extends({
...
exports.default = StitchingProfileComponent;