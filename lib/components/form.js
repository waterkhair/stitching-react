...
module.exports.FormInput = function (_ref4) {
    var disabled = _ref4.disabled,
        ...
        value = _ref4.value;
    return React.createElement("input", { className: inputClass, disabled: disabled, name: name, type: type, onChange: onChange, placeholder: placeholder, value: value });
};
