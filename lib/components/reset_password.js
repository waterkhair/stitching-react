...
var StitchingResetPasswordComponent = function (_StitchingBaseCompone) {
    _inherits(StitchingResetPasswordComponent, _StitchingBaseCompone);

    function StitchingResetPasswordComponent(props) {
        _classCallCheck(this, StitchingResetPasswordComponent);

        var _this = _possibleConstructorReturn(this, (StitchingResetPasswordComponent.__proto__ || Object.getPrototypeOf(StitchingResetPasswordComponent)).call(this, props));
    ...
    _createClass(StitchingResetPasswordComponent, [{
        key: "passwordReset",
            ...
            if (token && tokenId) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _form.Form,
                        { formClass: "stitching-form", id: id + "_ResetPasswordForm", message: message, messageClass: messageClass },
    ...
    return StitchingResetPasswordComponent;
}(_base2.default);

StitchingResetPasswordComponent.propTypes = _extends({
...
exports.default = StitchingResetPasswordComponent;